...
class updateAddress(View):
    ...
    def post(self,request,pk):
        ...
        if form.is_valid():
            ...
            add.save()
            messages.success(request,"Congrats!Profile Update Sucessful!!")
        else:
            messages.warning(request,"Invalid Input!")
...
class checkout(View):
    def get(self,request):
        ...
        #{'id': 'order_Mcfa1WzXTzRs0a', 'entity': 'order', 'amount': 724000, 'amount_paid': 0, 'amount_due': 724000, 'currency': 'INR', 'receipt': 'order_rcptid_12', 'offer_id': None, 'status': 'created', 'attempts': 0, 'notes': [], 'created_at': 1694793660}
