...
urlpatterns = [
    ...
    path('password-reset-confirm/<uidb64>/<token>/',auth_view.PasswordResetConfirmView.as_view(template_name='app/password_reset_confirm.html',form_class=PasswordSetForm),name='password_reset_confirm'),
...
admin.site.site_header="CODE_WEAR"
admin.site.site_title="CODE_WEAR"
admin.site.site_index_ttile="Welcome to CODE_WEAR!"